...
import GetHomeBoardUseCase from '../../../../modules/leaderboard/useCases/getHomeBoard/GetHomeBoardUseCase';
import GetHomeBoardController from '../../../../modules/leaderboard/useCases/getHomeBoard/GetHomeBoardController';
...
const getHomeBoardUseCase = new GetHomeBoardUseCase(matchesRepository);
